...
The APIs in MOM6 are documented using doxygen - you are viewing the result. A brief style guide for using doxygen in MOM6 is available in [docs/Code-style.md](Code-style.md).
