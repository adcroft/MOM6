...
subroutine reconstruct(this, h, u)
  ...
  ! ### Note that the PPM_HYBGEM option calcualed the CW PPM coefficients and then
  ! invoked the OM4-era limiters afterwards, effectively doing the limiteres twice.
...
logical function check_reconstruction(this, h, u)
  ...
  ! but actually passes due to the second pass of the limiters with explciti bounding.
